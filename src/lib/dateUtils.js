export const DateUtils = {
  ...
  formatDateForDisplay: function (dateString) {
    ...
    return `${date.getDate()} ${DateUtils.getMonthStringFromInt(
      date.getMonth(),
    )} ${date.getFullYear()}`;
  },
  ...
  getMonthAndYearFromTime: function (startTimeString) {
    ...
    return (
      DateUtils.getMonthStringFromInt(startDate.getMonth()) +
      " " +
  ...
  getTimeFromTime: function (startTimeString) {
    ...
    return `${DateUtils.addLeadingZero(
      startDate.getHours(),
    )}:${DateUtils.addLeadingZero(startDate.getMinutes())}`;
  },
